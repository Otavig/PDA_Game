...
function addDeleteEventListeners(table) {
    document.querySelectorAll('.btn-delete').forEach(button => {
        button.addEventListener('click', async (event) => {
            ...
            try {
                let response = await fetch(`http://localhost:3000/api/delete_item/${table}/${itemId}`, {
                    method: "DELETE"
                });
    ...
    if (tela === "sorte_ou_azar") {
        document.getElementById('submit_sorte_ou_azar').addEventListener('click', async () => {
            ...
            try {
                ...
                let response = await fetch(`http://localhost:3000/api/intra/sorte_ou_azar`, {
                    method: "POST",
                    body: formData
                });
        ...
        document.getElementById('submit_zona_de_perigo').addEventListener('click', async () => {
            ...
            try {
                ...
                let response = await fetch(`http://localhost:3000/api/intra/consequencia`, {
                    method: "POST",
                    body: formData
                });
        ...
        document.getElementById('submit_curiosidade').addEventListener('click', async () => {
            ...
            try {
                ...
                let response = await fetch(`http://localhost:3000/api/intra/curiosidade`, {
                    method: "POST",
                    body: formData
                });
        ...
        document.getElementById('submit_quizes').addEventListener('click', async () => {
            ...
            try {
                ...
                let response = await fetch(`http://localhost:3000/api/intra/quiz`, {
                    method: "POST",
                    body: formData
                });
